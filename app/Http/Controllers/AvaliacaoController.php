    ...
    public function botScript($slug)
    {
        ...
        $translations = [
            'pt' => [
                ...
                'recommend_maybe' => "💛 Que bom saber disso! Se puder, compartilha essa experiência no Google também",
            ...
            'ja' => [
                ...
                'recommend_maybe' => "💛 そう言っていただけて光栄です！もしよろしければ、Googleでもこの体験を共有していただけませんか？",
