    ...
    public function botScript($slug)
    {
        ...
        $translations = [
            'pt' => [
                ...
                'recommend_yes' => "💛 Que bom saber disso! Se puder, compartilha essa experiência no Google também",
                'recommend_maybe' => "Já ajuda bastante se você deixar no Google 🙌",
                'recommend_no' => "Tudo bem! Ficamos felizes que sua experiência foi boa. 👉 Sua avaliação no Google faz toda diferença para novos clientes",
            ...
            'ja' => [
                ...
                'recommend_yes' => "💛 そう言っていただけて光栄です！もしよろしければ、Googleでもこの体験を共有していただけませんか？",
                'recommend_maybe' => "Googleに評価を残していたidadeるだけでも大変助かります 🙌",
                'recommend_no' => "承知いたしました。良い体験をしていただけたようで何よりです。 👉 Googleへの評価は、他のお客様の参考になりますので大変助かります。",
