...
<!-- Page Header -->
<div class="mb-32">
    <h2 class="text-title-1 font-bold text-neutral-primary">{{ __('Minha Conta') }}</h2>
    <p class="text-body-m text-neutral-secondary">{{ __('Dados do estabelecimento') }}</p>
</div>
    ...
    <div class="grid lg:grid-cols-12 gap-32 items-start">
        ...
        <div class="lg:col-span-7 space-y-24">
            ...
            <div class="card p-24">
                <div class="flex items-center gap-8 mb-24">
                    ...
                    <h3 class="text-body-g font-bold text-neutral-primary">{{ __('Estabelecimento') }}</h3>
                </div>

                <div class="space-y-16">
                    <div>
                        <label class="block text-body-m font-bold text-neutral-secondary mb-4">{{ __('Nome') }}</label>
                    ...
                    <div>
                        <label class="block text-body-m font-bold text-neutral-secondary mb-4">{{ __('E-mail') }}</label>
                    ...
                    <div>
                        <label class="block text-body-m font-bold text-neutral-secondary mb-4">{{ __('Link do Google Maps') }}</label>
                        ...
                        <p class="text-legend text-neutral-secondary/60 mt-4">{{ __('Usado para redirecionar clientes satisfeitos.') }}</p>
                    </div>

                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-16">
                        <div>
                            <label class="block text-body-m font-bold text-neutral-secondary mb-4">{{ __('Telefone WhatsApp') }}</label>
                        ...
                        <div>
                            <label class="block text-body-m font-bold text-neutral-secondary mb-4">{{ __('LINE User ID (Japão)') }}</label>
            ...
            <div class="card p-24">
                <div class="flex items-center gap-8 mb-24">
                    ...
                    <h3 class="text-body-g font-bold text-neutral-primary">{{ __('Alterar senha') }}</h3>
                </div>

                <div class="space-y-16">
                    <div>
                        <label class="block text-body-m font-bold text-neutral-secondary mb-4">{{ __('Senha atual') }}</label>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-16">
                        <div>
                            <label class="block text-body-m font-bold text-neutral-secondary mb-4">{{ __('Nova senha') }}</label>
                            <input type="password" name="password" class="w-full border border-neutral-border rounded-lg px-12 py-8 text-body-m focus:ring-2 focus:ring-brand-600 focus:outline-none" placeholder="{{ __('Mínimo 8 caracteres') }}">
                        </div>
                        <div>
                            <label class="block text-body-m font-bold text-neutral-secondary mb-4">{{ __('Confirmar') }}</label>
                            <input type="password" name="password_confirmation" class="w-full border border-neutral-border rounded-lg px-12 py-8 text-body-m focus:ring-2 focus:ring-brand-600 focus:outline-none" placeholder="{{ __('Repetir senha') }}">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="lg:col-span-5 space-y-24">
            ...
            <div class="bg-brand-50 border border-brand-200 rounded-lg p-24 space-y-16">
                <span class="text-legend text-brand-600 font-bold uppercase tracking-wider">{{ __('Seu Plano') }}</span>
                ...
                <ul class="space-y-8 pt-8 border-t border-brand-200">
                    <li class="flex items-center gap-8 text-body-m text-brand-800 font-medium">
                        ...
                        <span>{{ __('Avaliações ilimitadas') }}</span>
                    </li>
                    <li class="flex items-center gap-8 text-body-m text-brand-800 font-medium">
                        <svg class="w-16 h-16 text-brand-600" fill="none" stroke="currentColor" stroke-width="3" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5"></path></svg>
                        <span>{{ __('Bot em 2 idiomas') }}</span>
                    </li>
                    <li class="flex items-center gap-8 text-body-m text-brand-800 font-medium">
                        <svg class="w-16 h-16 text-brand-600" fill="none" stroke="currentColor" stroke-width="3" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5"></path></svg>
                        <span>{{ __('Painel de ocorrências') }}</span>
                    </li>
                    <li class="flex items-center gap-8 text-body-m text-brand-800 font-medium">
                        <svg class="w-16 h-16 text-brand-600" fill="none" stroke="currentColor" stroke-width="3" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5"></path></svg>
                        <span>{{ __('QR Code personalizado') }}</span>
                    </li>
                    <li class="flex items-center gap-8 text-body-m text-brand-800 font-medium">
                        <svg class="w-16 h-16 text-brand-600" fill="none" stroke="currentColor" stroke-width="3" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M4.5 12.75l6 6 9-13.5"></path></svg>
                        <span>{{ __('Suporte via WhatsApp') }}</span>
                    </li>
                </ul>

                <p class="text-legend text-brand-600/70 font-semibold pt-4">
                    {{ __('Renova em') }} {{ $cliente->trial_ends_at ? $cliente->trial_ends_at->format('d/m/Y') : now()->addMonth()->format('01/m/Y') }}
                </p>
            </div>
