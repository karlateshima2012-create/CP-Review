...
<!-- Page Header -->
<div class="mb-32">
    <h2 class="text-title-1 font-bold text-neutral-primary">Divulgação</h2>
    ...
    <div class="lg:col-span-6 space-y-24">
        ...
        <div class="card p-24">
            <div class="flex items-center gap-12 mb-16">
                ...
                <svg class="w-28 h-28 flex-shrink-0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <div>
                    <span class="text-body-g font-bold text-neutral-primary block">Avaliações do Google</span>
                    <span class="text-legend text-neutral-secondary">Responda publicamente no seu Perfil da Empresa</span>
                </div>
            </div>

            <p class="text-body-m text-neutral-secondary leading-relaxed mb-16">
                Responder avaliações no Google demonstra cuidado com o cliente e melhora seu posicionamento nas buscas. Faça isso pelo Perfil da Empresa no Google.
            </p>

            <a href="https://business.google.com/reviews" target="_blank"
               class="w-full flex items-center justify-center gap-10 py-12 px-16 rounded-lg font-bold text-white transition shadow-sm"
               style="background: linear-gradient(135deg, #4285F4 0%, #34A853 100%);">
                ...
                <!-- External link icon -->
                <svg class="w-14 h-14 opacity-80" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <a href="{{ $cliente->google_maps_link }}" target="_blank"
               class="mt-10 w-full flex items-center justify-center gap-8 py-10 px-16 rounded-lg font-bold border border-neutral-border bg-white text-neutral-secondary hover:bg-neutral-bg transition text-body-m">
        ...
        <!-- Sharing Card -->
        <div class="card p-24">
            <span class="text-legend text-neutral-secondary font-bold uppercase tracking-wider block mb-16">Compartilhar link de avaliação</span>
