    ...
    <div class="lg:col-span-6 card p-24 flex flex-col items-center text-center">
        ...
        <div class="bg-neutral-bg border border-neutral-border rounded-lg px-16 py-12 mb-24 w-full text-center">
            ...
            <div id="eval-message" class="text-body-m text-neutral-primary leading-relaxed break-all">
                ...
                <a href="{{ route('avaliacao.show', ['slug' => $cliente->slug, 'v' => 2]) }}" id="eval-link" class="font-bold text-brand-600 hover:underline" target="_blank">
                    {{ route('avaliacao.show', ['slug' => $cliente->slug, 'v' => 2]) }}
                </a>
            </div>
        </div>
    ...
    <div class="lg:col-span-6 space-y-24">
        ...
        <div class="card p-24">
            ...
            <div class="grid grid-cols-3 gap-12">
                <!-- WhatsApp -->
                <a href="https://api.whatsapp.com/send?text=Olá!%20Por%20favor,%20deixe%20sua%20avaliação%20sobre%20nós%20em:%20{{ urlencode(route('avaliacao.show', ['slug' => $cliente->slug, 'v' => 2])) }}" target="_blank" class="border border-neutral-border bg-white hover:bg-neutral-bg py-12 px-8 rounded-lg text-body-m font-bold text-neutral-primary flex items-center justify-center transition text-center">
                    WhatsApp
                </a>
                <!-- LINE -->
                <a href="https://line.me/R/share?text=Olá!%20Por%20favor,%20deixe%20sua%20avaliação%20sobre%20nós%20em:%20{{ urlencode(route('avaliacao.show', ['slug' => $cliente->slug, 'v' => 2])) }}" target="_blank" class="border border-neutral-border bg-white hover:bg-neutral-bg py-12 px-8 rounded-lg text-body-m font-bold text-neutral-primary flex items-center justify-center transition text-center">
                    LINE
                </a>
                <!-- Email -->
                <a href="mailto:?subject=Deixe%20sua%20avaliação&body=Olá!%20Por%20favor,%20deixe%20sua%20avaliação%20sobre%20nós%20em:%20{{ route('avaliacao.show', ['slug' => $cliente->slug, 'v' => 2]) }}" class="border border-neutral-border bg-white hover:bg-neutral-bg py-12 px-8 rounded-lg text-body-m font-bold text-neutral-primary flex items-center justify-center transition text-center">
                    E-mail
                </a>
            </div>
        </div>
