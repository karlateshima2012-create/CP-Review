    ...
    <div class="lg:col-span-6 flex flex-col gap-16">
        ...
        <div class="card p-16 flex flex-col flex-1">
            <div class="flex items-center gap-10 mb-12">
                ...
                <div>
                    <span class="text-body-m font-bold text-neutral-primary block leading-tight">Avaliações do Google</span>
                    <span class="text-legend text-neutral-secondary">Responda publicamente pelo Perfil da Empresa</span>
                </div>
            </div>
