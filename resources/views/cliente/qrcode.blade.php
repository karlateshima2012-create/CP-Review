    ...
    <div class="lg:col-span-6 space-y-24">
        ...
        <div class="card p-24">
            ...
            <div class="grid grid-cols-3 gap-12">
                <!-- WhatsApp -->
                <a href="https://api.whatsapp.com/send?text=Olá!%20Por%20favor,%20deixe%20sua%20avaliação%20sobre%20nós%20em:%20{{ urlencode(route('avaliacao.show', $cliente->slug)) }}" target="_blank" class="border border-neutral-border bg-white hover:bg-neutral-bg py-12 px-8 rounded-lg text-body-m font-bold text-neutral-primary flex items-center justify-center transition text-center">
                    WhatsApp
                </a>
                <!-- LINE -->
                <a href="https://line.me/R/share?text=Olá!%20Por%20favor,%20deixe%20sua%20avaliação%20sobre%20nós%20em:%20{{ urlencode(route('avaliacao.show', $cliente->slug)) }}" target="_blank" class="border border-neutral-border bg-white hover:bg-neutral-bg py-12 px-8 rounded-lg text-body-m font-bold text-neutral-primary flex items-center justify-center transition text-center">
                    LINE
                </a>
                <!-- Email -->
                <a href="mailto:?subject=Deixe%20sua%20avaliação&body=Olá!%20Por%20favor,%20deixe%20sua%20avaliação%20sobre%20nós%20em:%20{{ route('avaliacao.show', $cliente->slug) }}" class="border border-neutral-border bg-white hover:bg-neutral-bg py-12 px-8 rounded-lg text-body-m font-bold text-neutral-primary flex items-center justify-center transition text-center">
                    E-mail
                </a>
            </div>
        </div>
