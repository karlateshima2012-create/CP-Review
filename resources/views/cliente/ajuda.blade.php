...
<div class="max-w-3xl space-y-24">
    ...
    <div class="card p-24 bg-brand-50 border border-brand-100">
        ...
        <a href="{{ route('cliente.conta', $cliente->id) }}"
           class="inline-flex items-center gap-8 bg-brand-600 text-white py-10 px-20 rounded-lg font-bold hover:bg-brand-700 transition text-body-m mx-auto block w-fit">
