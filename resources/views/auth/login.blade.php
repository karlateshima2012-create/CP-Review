    ...
    <div class="max-w-md w-full space-y-8 bg-white p-6 sm:p-10 rounded-3xl border border-gray-100 shadow-xl">
        <div>
            <div class="mx-auto flex items-center justify-center">
                <img src="/logo.png?v={{ file_exists(public_path('logo.png')) ? filemtime(public_path('logo.png')) : time() }}" alt="CP Review" class="h-[48px] w-auto">
            </div>
            <h2 class="mt-6 text-center text-title-2 font-extrabold text-gray-900 tracking-tight">
                Bem-vindo de volta
            </h2>
        </div>
        ...
        <form class="mt-8 space-y-6" action="{{ route('login') }}" method="POST">
            ...
            <div class="flex justify-end">
                <div class="text-base">
                    <a href="https://wa.me/819011886491" target="_blank" class="font-semibold text-purple-600 hover:text-purple-500 transition-colors">
                        Esqueceu a senha?
                    </a>
                </div>
            </div>
        ...
        <div class="mt-8 text-center border-t border-gray-50 pt-6">
            <a href="{{ url('/') }}" class="inline-block text-sm font-semibold text-gray-500 hover:text-purple-600 underline decoration-gray-200">
                ← Voltar para a Home
            </a>
        </div>
    </div>
