    ...
    <div class="max-w-md w-full space-y-8 bg-white/10 backdrop-blur-xl p-10 rounded-3xl border border-white/20 shadow-2xl">
        ...
        <div class="mt-8 pt-8 border-t border-white/20">
            ...
            <div class="grid grid-cols-1 gap-3">
                <a href="{{ url('/avaliar/creative-print') }}" target="_blank" class="flex flex-col items-center justify-center p-4 bg-white/10 hover:bg-white/20 border border-white/10 rounded-xl text-white text-sm transition-all group">
                    ...
                    <div class="p-2 bg-white rounded-lg shadow-inner">
                        <img src="https://api.qrserver.com/v1/create-qr-code/?size=120x120&data={{ urlencode(url('/avaliar/creative-print')) }}" alt="QR Code PWA" width="100" height="100">
                    </div>
                </a>
