                    ...
                    <tr class="hover:bg-gray-50/50 transition-colors group">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-2">
                                ...
                                <!-- Impersonate -->
                                <form method="POST" action="{{ route('admin.clientes.impersonate', $cliente->id) }}">
                                    @csrf
                                    <button type="submit" class="p-2 bg-gray-100 hover:bg-orange-100 hover:text-orange-700 rounded-lg transition flex items-center justify-center text-gray-500" title="Logar como este Cliente">
                                        <svg class="w-16 h-16" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
